        ...
        setFormData(
            {
                ...
                facebook: loading || !profile.fsocial ? '' : profile.social.facebook,
                linkedin: loading || !profile.lsocial ? '' : profile.social.linkedin,
    ...
    return (
        <Fragment>
            ...
            <form className="form" onSubmit={e => onSubmit(e)}>
                ...
                <div className="my-2">
                <button onClick={() => toggleSocialInputs(!displaySocialInputs)} type="button" id="btnSocialNetworks" className="btn btn-light">
